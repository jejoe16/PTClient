...
namespace PTClient.IO.Swagger.Model
{
    ...
    public partial class InlineResponse204 :  IEquatable<InlineResponse204>, IValidatableObject
    {
        ...
        public InlineResponse204(List<TurbineItem> Routemarker = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InlineResponse204);
        }

        /// <summary>
        /// Returns true if InlineResponse204 instances are equal
        /// </summary>
        /// <param name="other">Instance of InlineResponse204 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse204 other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.Routemarker == other.Routemarker ||
                    this.Routemarker != null &&
                    this.Routemarker.SequenceEqual(other.Routemarker)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Routemarker != null)
                    hash = hash * 59 + this.Routemarker.GetHashCode();
                return hash;
            }
        }
